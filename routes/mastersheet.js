...
// PUT and shift candidate to the interestedCandidates[] of the process
router.put("/candidate/:id", async (req, res) => {
  try {
    ...
    // Update candidate with new entries
    ...
    if (newAssignProcess && newAssignProcess !== candidate.assignProcess) {
